# WordPress the-inventory

A to-come integration for the-inventory website with WordPress
...
To come on tellementnomade.org

## Installation

the-inventory requires Pods plugin to be installed and the schema.json to be imported
